...
class Prueba {
  ...
  @override
  String toString() {
    return 'Prueba(id: $id, start_date: $start_date, end_date: $end_date, title: $title, description: $description, location: $location, all_day: $all_day, alarm: $alarm, reminder: $reminder)';
  }
