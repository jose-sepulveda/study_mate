...
class Otro {
  ...
  factory Otro.fromMap(Map<String, dynamic> map) {
    return Otro(
  ...
  factory Otro.fromJson(String source) =>
      Otro.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'Otro(id: $id, start_date: $start_date, end_date: $end_date, title: $title, location: $location, all_day: $all_day, alarm: $alarm, reminder: $reminder)';
  }

  @override
  bool operator ==(covariant Otro other) {
